...
// import PhotoComp from '../assets/photocomp.png'
import '../styles/companypres.css'
...
const CompanyPresentation = () => {
    return (
        <div className='company'>
            <div className='about'>
                <h1>Welcome To EasyBill </h1><br />
                <h3>The Billing Software you need</h3><br />
                <h3>Create professional invoices in 60 seconds!</h3>
            ...
            <div className='animated-graph-container'>
                <svg className='graph-svg' width="529px" height="286px" viewBox="30 27 529 286" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    ...
                    <g id="graph-copy" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(30.000000, 27.000000)">
                        ...
                        <g id="GRAPHS" transform="translate(64.000000, 16.000000)" stroke-linecap="round" stroke-width="8" stroke-linejoin="round">
                            <polyline id="Banks" stroke="#3586ff" points="0 1 88.0438662 1 128.985782 137 180.170616 137 224.189573 182 256.947867 91 301.990521 137 346.009479 91 392.087202 91 429.952607 179"></polyline>
                            <polyline id="Bridge" stroke="#3586ff" points="2.04739336 183 54.2559242 227 96.2274882 47 133.080569 1 302.018438 1 346.680361 44.6280822 386.957346 0 427.905213 43"></polyline>
                            <polyline id="PayPal" stroke="#3586ff" points="2.04739336 180 53.273159 180 99.2985782 91 137.175355 47 219.077488 47 256.947867 90 301.990521 47 349.080569 137 398.228672 137 432 91"></polyline>
                        </g>
